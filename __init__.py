...
def smartcsvsort(input_filename, columns, output_filename='', max_size=100, has_header=True, delimiter=',', quoting=csv.QUOTE_MINIMAL, encoding='utf-8', **kwargs):
    ...
    try:
        with open(input_filename, 'r', encoding=encoding, transport_params=kwargs.get('transport_params')) as input_fp:
        ...
        with open(output_filename or input_filename, 'w', newline='\n', encoding=encoding, transport_params=kwargs.get('transport_params')) as output_fp:
